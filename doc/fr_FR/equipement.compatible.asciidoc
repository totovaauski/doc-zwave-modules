...
[big red]*Actuellement Jeedom est compatible avec* [big red yellow-background]*5* [red]*marques de modules différentes, soit un total de* [big red  yellow-background]*22* [big red]*modules.*
