...
image::../images/greenwave.Powernode1/module.jpg[width=256]
...
image::../images/greenwave.Powernode1/vuedefaut1.jpg[width=200]
...
image::../images/greenwave.Powernode1/inclusion.jpg[width=350]
...
* Reset : C'est la commande qui permet de remettre à zéro la consommation cumulée
...
A noter que sur le dashboard le bouton reset n'est pas visible par défaut. De plus les commandes ON/OFF/ETAT sont regroupées en un seul bouton.
...
image::../images/greenwave.Powernode1/vuewidget.jpg[width=150]
