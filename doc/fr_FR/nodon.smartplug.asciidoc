:icons:
== Noton Prise Intelligente - Smartplug
...
image::../images/nodon.smartplug/module.jpg[width=256]
...
image::../images/nodon.smartplug/vuedefaut1.jpg[width=200]
...
image::../images/nodon.smartplug/inclusion.jpg[width=350]
...
[icon="../images/plugin/important.png"]
[IMPORTANT]
A minima Jeedom devrait se retrouver dans les groupes 1 et
{nbsp} +
...
* Bien qu'un widget permet d'afficher le statut de l'alarme il peut être utile de connaitre les valeurs associées pour faire des scénarios, les voici : 2 = coupure de courant | 3 ou 254 = reprise de courant
