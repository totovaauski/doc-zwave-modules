...
image::../images/greenwave.powernode/module.jpg[width=256]
...
image::../images/greenwave.powernode/vuedefaut1.jpg[width=400]
...
include::template_installationzwave.asciidoc[]

=== Configuration

{nbsp} +

include::template_inclusion.asciidoc[]
...
image::../images/greenwave.powernode/inclusion.jpg[width=250]
...
* Reset-1 : C'est la commande qui permet de remettre à zéro la consommation cumulée de la prise 1
...
* Reset-2 : C'est la commande qui permet de remettre à zéro la consommation cumulée de la prise 2
...
* Reset-3 : C'est la commande qui permet de remettre à zéro la consommation cumulée de la prise 3
...
* Reset-4 : C'est la commande qui permet de remettre à zéro la consommation cumulée de la prise 4
...
* Reset-5 : C'est la commande qui permet de remettre à zéro la consommation cumulée de la prise 5
...
* Reset-6 : C'est la commande qui permet de remettre à zéro la consommation cumulée de la prise 6
...
A noter que sur le dashboard les boutons reset ne sont pas visibles par défaut. De plus les commandes ON/OFF/ETAT sont regroupées en un seul bouton.
...
image::../images/greenwave.powernode/Cron.jpg[width=350]

{nbsp} +

Le cron par défaut est de 15 minutes, mais vous pouvez le modifier selon vos besoins

{nbsp} +

[icon="../images/plugin/important.png"]
[IMPORTANT]
Un polling/CRON trop bas peut saturer et rendre inopérant votre réseau Zwave. Il est déconseillé de descendre en dessous de 10 minutes.
...
image::../images/greenwave.powernode/consocumul.jpg[width=150]
...
image::../images/greenwave.powernode/consocumul2.jpg[width=550]
...
image::../images/greenwave.powernode/vuewidget.jpg[width=350]
