...
* 8: permet de définir la durée par pas de 8 secondes de redection de mouvement
...
* 12: permet de définir la durée entre deux rapports auto de luminosité (une unité = parametre 20)
* 13: permet de définir la durée entre deux rapports auto de température (une unité = parametre 20)
* 20: durée d'un intervalle pour les paramètres 10 à 13
* 21: valeur de variation en °F de température pour déclencher un rapport
* 22: valeur en % de variation de luminosité pour déclencher un rapport
